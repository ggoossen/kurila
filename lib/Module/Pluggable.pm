...
sub import {
    ...
    *{Symbol::qualify_to_ref("$package\::$sub")}    = $subroutine;
    *{Symbol::qualify_to_ref("$package\::search_path")} = $searchsub;
    *{Symbol::qualify_to_ref("$package\::only")}        = $onlysub;
    *{Symbol::qualify_to_ref("$package\::except")}      = $exceptsub;

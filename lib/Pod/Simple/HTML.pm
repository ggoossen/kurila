...
sub do_url_link(@< @_) { return @_[1]->attr('to') }
...
sub resolve_pod_link_by_table(@< @_) {
...
sub linearize_tokens(@< @_) {  # self, tokens
    my $self = shift @_;
    my $out = '';

...
package P5AST::op_anonscalar; 	@ISA = 'P5AST::padop_svop';
...
package P5AST::op_logassign_assign; 	@ISA = 'P5AST::baseop';
...
package P5AST::op_dotdotdot; 	@ISA = 'P5AST::baseop';
package P5AST::op_placeholder; 	@ISA = 'P5AST::baseop';
package P5AST::op_dynascope; 	@ISA = 'P5AST::baseop_unop';
...
package P5AST::op_ref_eq; 		@ISA = 'P5AST::binop';
package P5AST::op_ref_ne; 		@ISA = 'P5AST::binop';
package P5AST::op_code_eq; 		@ISA = 'P5AST::binop';
package P5AST::op_code_ne; 		@ISA = 'P5AST::binop';
...
package P5AST::op_expand; 	@ISA = 'P5AST::baseop_unop';
package P5AST::op_hashexpand; 	@ISA = 'P5AST::baseop_unop';
package P5AST::op_arrayexpand; 	@ISA = 'P5AST::baseop_unop';
package P5AST::op_enter_hashexpand_assign; 	@ISA = 'P5AST::baseop';
package P5AST::op_enter_arrayexpand_assign; 	@ISA = 'P5AST::baseop';
...
package P5AST::op_emptyarray; 	@ISA = 'P5AST::baseop';
package P5AST::op_emptyhash; 	@ISA = 'P5AST::baseop';
package P5AST::op_anonlist; 	@ISA = 'P5AST::listop';
package P5AST::op_anonarray; 	@ISA = 'P5AST::op_anonlist';
package P5AST::op_enter_anonarray_assign; 	@ISA = 'P5AST::baseop';
package P5AST::op_anonhash; 	@ISA = 'P5AST::listop';
package P5AST::op_enter_anonhash_assign; 	@ISA = 'P5AST::baseop';
...
package P5AST::op_nelems; 	@ISA = 'P5AST::listop';
package P5AST::op_nkeys; 	@ISA = 'P5AST::listop';
...
package P5AST::op_entersub_save; 	@ISA = 'P5AST::unop';
package P5AST::op_entersub_targargs; 	@ISA = 'P5AST::unop';

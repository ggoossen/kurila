...
$insn_data{op_static} = [97, \&PUT_U8, "GET_U8"];
$insn_data{op_flags} = [98, \&PUT_U8, "GET_U8"];
$insn_data{op_private} = [99, \&PUT_U8, "GET_U8"];
$insn_data{op_first} = [100, \&PUT_opindex, "GET_opindex"];
$insn_data{op_last} = [101, \&PUT_opindex, "GET_opindex"];
$insn_data{op_other} = [102, \&PUT_opindex, "GET_opindex"];
$insn_data{op_pmreplroot} = [103, \&PUT_opindex, "GET_opindex"];
$insn_data{op_pmreplstart} = [104, \&PUT_opindex, "GET_opindex"];
$insn_data{op_pmnext} = [105, \&PUT_opindex, "GET_opindex"];
$insn_data{op_pmstashpv} = [106, \&PUT_pvindex, "GET_pvindex"];
...
$insn_data{op_pmpermflags} = [112, \&PUT_U16, "GET_U16"];
$insn_data{op_pmdynflags} = [113, \&PUT_U8, "GET_U8"];
...
$insn_data{cop_arybase} = [127, \&PUT_I32, "GET_I32"];

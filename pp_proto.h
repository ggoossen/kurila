...
PERL_PPDEF(Perl_pp_dotdotdot)
PERL_PPDEF(Perl_pp_placeholder)
...
PERL_PPDEF(Perl_pp_ref_eq)
PERL_PPDEF(Perl_pp_ref_ne)
PERL_PPDEF(Perl_pp_code_eq)
PERL_PPDEF(Perl_pp_code_ne)
...
PERL_PPDEF(Perl_pp_enter_anonarray_assign)
PERL_PPDEF(Perl_pp_enter_anonhash_assign)
PERL_PPDEF(Perl_pp_anonarray)
PERL_PPDEF(Perl_pp_anonhash)
PERL_PPDEF(Perl_pp_listlast)
PERL_PPDEF(Perl_pp_listfirst)
PERL_PPDEF(Perl_pp_expand)
PERL_PPDEF(Perl_pp_arrayexpand)
PERL_PPDEF(Perl_pp_enter_arrayexpand_assign)
PERL_PPDEF(Perl_pp_hashexpand)
PERL_PPDEF(Perl_pp_enter_hashexpand_assign)
PERL_PPDEF(Perl_pp_nelems)
...
PERL_PPDEF(Perl_pp_arrayjoin)
PERL_PPDEF(Perl_pp_hashjoin)
PERL_PPDEF(Perl_pp_arrayconcat)
PERL_PPDEF(Perl_pp_hashconcat)
PERL_PPDEF(Perl_pp_emptyarray)
PERL_PPDEF(Perl_pp_emptyhash)

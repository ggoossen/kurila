...
Unicode 1.0 was released in October 1991, and 5.0 in October 2006.
...
=head2 Perl's Unicode Support History
...
In Perl 5.6.x releases the C<utf8> pragma was used to declare
that operations in the current block or file would be Unicode-aware.
In Perl 5.8.x the "Unicodeness" is carried with the data, instead of
being attached to the operations. Only one case remained where an explicit C<use utf8> was
...
literals, by saying C<use utf8>.

Perl kurila restores the meaning of the C<utf8> pragma as to mean
Unicode-aware. And might change the default to Unicode-aware.

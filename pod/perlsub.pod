...
but not beyond it.  See L<kurilasyn/"Simple statements"> for information
...
such arguments to a typeglob reference, use Symbol::fetch_glob() as
follows:
...
If you call a subroutine that is undefined, you 

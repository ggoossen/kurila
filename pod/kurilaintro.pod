...
Keep Perl 5 alive, and not let it be drowned by its burden of legacy features.
...
No. There is a lot of Perl 5 code. You can probably convert to Kurila without
much problems, but if you are happy with Perl 5, you can stay using it.
They can be installed both at the same time.

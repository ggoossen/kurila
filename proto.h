...
PERL_INLINE_CALLCONV SV**	Perl_avpTsvp(pTHX_ AV **avp);
PERL_INLINE_CALLCONV SV**	Perl_hvpTsvp(pTHX_ HV **hvp);
PERL_INLINE_CALLCONV SV**	Perl_cvpTsvp(pTHX_ CV **cvp);
...
PERL_CALLCONV void	Perl_av_tmprefcnt(pTHX_ AV *av)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_AV_TMPREFCNT	\
	assert(av)
...
#endif
PERL_CALLCONV OP*	Perl_convert(pTHX_ I32 optype, OPFLAGS flags, OP* o, SV* location)
			__attribute__warn_unused_result__;
...
PERL_CALLCONV void	Perl_cv_tmprefcnt(pTHX_ CV* cv)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_CV_TMPREFCNT	\
	assert(cv)
...
PERL_CALLCONV char*	Perl_fbm_instr(pTHX_ char* big, char* bigend, SV* littlestr, U32 flags)
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2)
			__attribute__nonnull__(pTHX_3);
...
PERL_CALLCONV CV*	Perl_gv_fetchmeth(pTHX_ HV* stash, const char* name, STRLEN len, I32 level)
			__attribute__nonnull__(pTHX_2);
#define PERL_ARGS_ASSERT_GV_FETCHMETH	\
	assert(name)

PERL_CALLCONV CV*	Perl_gv_fetchmethod(pTHX_ HV* stash, const char* name)
			__attribute__nonnull__(pTHX_2);
...
PERL_INLINE_CALLCONV void	Perl_hv_store(pTHX_ HV *hv, const char *key, I32 klen, SV *val, U32 hash);
PERL_INLINE_CALLCONV void	Perl_hv_store_ent(pTHX_ HV *hv, SV *key, SV *val, U32 hash);
PERL_INLINE_CALLCONV void	Perl_hv_store_flags(pTHX_ HV *hv, const char *key, I32 klen, SV *val, U32 hash, int flags);
PERL_CALLCONV void	Perl_hv_undef(pTHX_ HV *hv);
PERL_CALLCONV void	Perl_hv_tmprefcnt(pTHX_ HV *hv)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_HV_TMPREFCNT	\
	assert(hv)
...
PERL_CALLCONV I32	Perl_ibcmp_utf8(pTHX_ const char* s1, char **pe1, UV l1, const char* s2, char **pe2, UV l2)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_4);
...
PERL_CALLCONV void	Perl_mg_tmprefcnt(pTHX_ SV* sv)
			__attribute__nonnull__(pTHX_1);
...
PERL_CALLCONV OP*	Perl_assign(pTHX_ OP* o, bool partial, I32 *min_modcount, I32 *max_modcount)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4);
...
PERL_CALLCONV OP*	Perl_op_assign(pTHX_ OP** po, I32 optype)
			__attribute__nonnull__(pTHX_1);
...
PERL_CALLCONV PerlIO*	Perl_my_popen_list(pTHX_ const char* mode, int n, SV * const * args)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_3);
...
PERL_CALLCONV OP*	Perl_newASSIGNOP(pTHX_ OPFLAGS flags, OP* left, I32 optype, OP* right, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;

PERL_CALLCONV OP*	Perl_newCONDOP(pTHX_ OPFLAGS flags, OP* first, OP* trueop, OP* falseop, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_2);
...
PERL_CALLCONV OP*	Perl_newLOGOP(pTHX_ I32 optype, OPFLAGS flags, OP *first, OP *other, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4);
...
PERL_CALLCONV OP*	Perl_newOP(pTHX_ I32 optype, OPFLAGS flags, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;
...
PERL_CALLCONV OP*	Perl_newSTATEOP(pTHX_ OPFLAGS flags, char* label, OP* o, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;
...
PERL_CALLCONV OP*	Perl_newBINOP(pTHX_ I32 type, OPFLAGS flags, OP* first, OP* last, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;

PERL_CALLCONV OP*	Perl_newCVREF(pTHX_ OPFLAGS flags, OP* o, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;

PERL_CALLCONV OP*	Perl_newGVOP(pTHX_ I32 type, OPFLAGS flags, GV* gv, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_3);
...
PERL_CALLCONV OP*	Perl_newPMOP(pTHX_ I32 type, OPFLAGS flags, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;

PERL_CALLCONV OP*	Perl_newPVOP(pTHX_ I32 type, OPFLAGS flags, char* pv, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;
...
PERL_CALLCONV OP*	Perl_newSVOP(pTHX_ I32 type, OPFLAGS flags, SV* sv, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_3);
...
PERL_CALLCONV OP*	Perl_newUNOP(pTHX_ I32 type, OPFLAGS flags, OP* first, SV* location)
			__attribute__malloc__
			__attribute__warn_unused_result__;
...
PERL_CALLCONV void	Perl_preg_tmprefcnt(pTHX_ REGEXP *rx)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_PREG_TMPREFCNT	\
	assert(rx)
...
PERL_INLINE_CALLCONV void	Perl_save_hints(pTHX);
...
PERL_INLINE_CALLCONV void	Perl_save_pushi32ptr(pTHX_ const I32 i, void *const ptr, const int type);
PERL_CALLCONV void	Perl_save_pushptrptr(pTHX_ void *const ptr1, void *const ptr2, const int type);
PERL_INLINE_CALLCONV void	Perl_save_pushptri32ptr(pTHX_ void *const ptr1, const I32 i, void *const ptr2, const int type);
...
PERL_CALLCONV OP*	Perl_op_mod_assign(pTHX_ OP* otor, OP** oandp, I32 optype)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2);
#define PERL_ARGS_ASSERT_OP_MOD_ASSIGN	\
	assert(otor); assert(oandp)
...
PERL_CALLCONV const char*	Perl_parse_escape(pTHX_ const char *s, char *d, STRLEN *l, const char *send)
			...
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4);
#define PERL_ARGS_ASSERT_PARSE_ESCAPE	\
	assert(s); assert(d); assert(l); assert(send)
...
PERL_CALLCONV void	Perl_sv_setrv(pTHX_ SV *const sv, SV* dst)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2);
#define PERL_ARGS_ASSERT_SV_SETRV	\
	assert(sv); assert(dst)

PERL_CALLCONV void	Perl_sv_setrv_mg(pTHX_ SV *const sv, SV* dst)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2);
#define PERL_ARGS_ASSERT_SV_SETRV_MG	\
	assert(sv); assert(dst)
...
STATIC OP*	S_new_logop(pTHX_ I32 type, OPFLAGS flags, OP **firstp, OP **otherp, SV *location)
			__attribute__warn_unused_result__
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4);
...
STATIC regnode*	S_regclassfold(pTHX_ struct RExC_state_t *pRExC_state, U32 depth)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_REGCLASSFOLD	\
	assert(pRExC_state)

STATIC regnode*	S_regclassfold_value(pTHX_ struct RExC_state_t *pRExC_state, UV value)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_REGCLASSFOLD_VALUE	\
	assert(pRExC_state)

STATIC void	S_anyof_get_swash(pTHX_ struct RExC_state_t *pRExC_state, regnode *ret, SV *listsv, AV* unicode_alternate)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2)
			__attribute__nonnull__(pTHX_3);
#define PERL_ARGS_ASSERT_ANYOF_GET_SWASH	\
...
STATIC I32	S_study_chunk(pTHX_ struct RExC_state_t *pRExC_state, regnode **scanp, I32 *minlenp, I32 *deltap, regnode *last, struct scan_data_t *data, I32 stopparen, char* recursed, struct regnode_charclass_class *and_withp, U32 flags, U32 depth)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2)
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4)
...
STATIC char*	S_reghop3(char *s, I32 off, char *lim)
			__attribute__warn_unused_result__
			__attribute__nonnull__(1)
			__attribute__nonnull__(3);
...
STATIC char*	S_reghop3c(char *s, I32 off, char *lim)
			__attribute__warn_unused_result__
			__attribute__nonnull__(1)
			__attribute__nonnull__(3);
...
STATIC char*	S_reghopmaybe3(char *s, I32 off, const char *lim)
			__attribute__warn_unused_result__
			__attribute__nonnull__(1)
			__attribute__nonnull__(3);
...
STATIC STRLEN	S_sv_pos_u2b_midway(const char *const start, const char *send, const STRLEN uoffset, const STRLEN uend)
			__attribute__nonnull__(1)
			__attribute__nonnull__(2);
#define PERL_ARGS_ASSERT_SV_POS_U2B_MIDWAY	\
	assert(start); assert(send)

STATIC STRLEN	S_sv_pos_u2b_cached(pTHX_ SV *sv, MAGIC **mgp, const char *const start, const char *const send, const STRLEN uoffset, STRLEN uoffset0, STRLEN boffset0)
			__attribute__nonnull__(pTHX_1)
			__attribute__nonnull__(pTHX_2)
			__attribute__nonnull__(pTHX_3)
			__attribute__nonnull__(pTHX_4);
...
PERL_CALLCONV bool	Perl_vdie_common(pTHX_ SV *msv, bool warn)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_VDIE_COMMON	\
	assert(msv)
...
PERL_CALLCONV void	Perl_pad_tmprefcnt(pTHX_ CV* cv)
			__attribute__nonnull__(pTHX_1);
...
PERL_CALLCONV void	Perl_append_madprops_pv(pTHX_ const char* v, OP* o, char slot)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_APPEND_MADPROPS_PV	\
	assert(v)

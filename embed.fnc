...
Aip	|datatype	|Dtype	|NN SV *sv
Aip	|const char*	|Ddesc	|NN SV *sv
...
Ep	|void	|magic_get	|NN const char* name|NN SV* sv
...
ip	|void	|save_pushi32ptr|const I32 i|NULLOK void *const ptr|const int type
...
p	|OP*	|op_mod_assign	|NN OP* otor|NN OP** oandp|I32 optype

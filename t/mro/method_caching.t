...
my @testsubs = @(
    ...
    sub { undef *MCTest::Base::foo; try { 'MCTest::Derived'->foo(0) }; like($@->{description}, qr/locate object method/); },
    ...
    sub { undef *MCTest::Base::; try { 'MCTest::Derived'->foo(0) }; like($@->{description}, qr/locate object method/); },
